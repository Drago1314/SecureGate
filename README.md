...
git clone [https://github.com/YOUR\_USERNAME/QuantumHacks\_Backend.git](https://github.com/YOUR\_USERNAME/QuantumHacks\_Backend.git)\
cd QuantumHacks\_Backend/backend
...
We have provided helper scripts that will install requirements and boot up the Uvicorn server automatically.
...
- GET /alerts/{resident\_id} - Fetch active security alerts for a specific flat.
...
1. **JWT Authentication:** Securing API endpoints with short-lived access tokens.
1. **Blockchain Audit Logs:** Hashing entry logs into a private ledger to prevent post-incident tampering.
